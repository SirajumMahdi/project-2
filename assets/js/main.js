! function(e) {
    ...
    e(document).ready(function() {
        ...
        var o;
        o = e("header.sticky-header"), e(window).scrollTop() < e("header").height() + 10 ? o.removeClass("sticky-on") : o.addClass("sticky-on")
    }), e(window).on("load", function() {
        e("#postWarpperLoaded").imagesLoaded(function() {
            e(".masonary-posts").isotope()
        }), e("#postWarpperLoaded").imagesLoaded(function() {
            e(".sidebar-masonary").isotope()
        })
    })
}(jQuery);